					...
					<div class="container">
						<div class="row">
							<div class="col-xs-12 col-sm-4 col-md-4 top-search-holder m-t-10">
								<!-- ============================================== SEARCH BAR ============================================== -->
								<form class="search-form" id="f1" action="${pageContext.request.contextPath }/SerachServlet" role="search" method="POST">
									<div class="form-group">
										<label class="sr-only" for="page-search">Type your
											search here</label> <input id="page-search"
											class="search-input form-control" name="name" type="text"
							...
							<div
								...
								<div class="media free-delivery hidden-xs ">
									<span class="media-left"><img
										src="http://localhost:8080/bookstore/assets/images/delivery-icon.png" height="48" width="48"
										alt=""></span>
							...
							<div
								...
								<ul class="clearfix shopping-cart-block list-unstyled">
									<li class="dropdown"><a class="clearfix" href="#"> <span
											class="pull-right cart-right-block"> <img
												src="http://localhost:8080/bookstore/assets/images/cart-icon.png" alt="" width="46"
												height="39" />
										</span>
											    ...
											    <div class="col-md-3 col-sm-4 books-by-subject">
													<div class="book">
														<div class="book-cover">
															<a href="#"><img
																src="http://localhost:8080/bookstore/images/${book.image}"
																data-echo="http://localhost:8080/bookstore/images/${book.image}" alt=""
																width="140" height="212" /></a>
														...
														<div class="book-details clearfix">
															<div class="book-description">
																...
																作者：${book.author }
																<p class="item-number">售价:${book.price }</p>
								    						    <p><a href="${pageContext.request.contextPath }/client/BuyServlet?bookid=${book.id}">加入购物车</a></p>
															</div>
														</div>
													</div>
												</div>
