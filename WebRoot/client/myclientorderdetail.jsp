...
<link
	...
	rel="stylesheet">
<link href="${pageContext.request.contextPath }/assets/css/main.min.css"
	rel="stylesheet">
...
<body>
				...
				<nav class="navbar navbar-bookshop navbar-static-top"
					...
					<div class="container">
						<div class="row">
							...
							<!-- /.col -->
							<div class="col-md-3 col-xs-10 col-sm-10 navbar-left"></div>
							<!-- /.col -->
									...
									<ul class="nav navbar-nav navbar-right">
										<li class="hidden-xs hidden-sm"><a
											href="${pageContext.request.contextPath }/client/IndexServlet?method=getAll">
												欢迎您：${user.username }</a></li>
										<li class="hidden-xs hidden-sm"><a
											href="${pageContext.request.contextPath }/client/mycart.jsp">查看购物车</a></li>
										<li class="hidden-xs hidden-sm"><a
											href="${pageContext.request.contextPath }/client/ClientListOrderServlet?userid=${user.id}">查看订单</a></li>
										<li class="hidden-xs hidden-sm"><a
											href="${pageContext.request.contextPath }/client/LoginOutServlet">注销</a></li>
									</ul>
								</c:if>
								<!-- /.nav -->
							</div>
					...
					<div class="row">
						...
						<div class="divider">
							<img class="img-responsive"
								src="http://localhost:8080/bookstore/assets/images/shadow.png"
								alt="">
						</div>
						<!-- /.divider -->
					</div>
									...
									<div class="footer-module-body m-t-20 clearfix">
										<p>
											<span class="pull-left"><img
												src="http://localhost:8080/bookstore/assets/images/footer-logo.png"
												alt="" width="75" height="75"></span>A cras tincidunt, ut
											tellus et. Gravida scele risque, ipsum sed iacul is, nunc non
											namtellus. Placerat sed phasellus, purus purus elit. Cras
											ante eros. Erat vel. Donec vestibulum sed, vel euismod donec.
										</p>
									</div>
								</div>
							</div>
							...
							<div class="col-md-12">
								<div class="pull-left">
									<ul class="payment-list list-unstyled">
										<li><a href="#"><img
												src="http://localhost:8080/bookstore/assets/images/payments/1.png"
												class="img-responsive" height="22" alt=""></a></li>
	...
	<!-- /#wrapper -->
	<script
		src="http://localhost:8080/bookstore/assets/js/jquery-1.11.2.min.js"></script>
	<script
		src="http://localhost:8080/bookstore/assets/js/bootstrap.min.js"></script>
	<script
		src="http://localhost:8080/bookstore/assets/js/bootstrap-hover-dropdown.min.js"></script>
	<script
		src="http://localhost:8080/bookstore/assets/js/owl.carousel.min.js"></script>
	<script
		src="http://localhost:8080/bookstore/assets/js/perfect-scrollbar.min.js"></script>
	<script
		src="http://localhost:8080/bookstore/assets/js/jquery-ui.min.js"></script>
	<script
		src="http://localhost:8080/bookstore/assets/js/jquery.customSelect.min.js"></script>
	<script
		src="http://localhost:8080/bookstore/assets/js/jquery.easing-1.3.min.js"></script>
